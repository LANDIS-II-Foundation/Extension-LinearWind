...
#define ExtensionName "Linear Wind"
...
AppId={{6A6B2312-6695-4C82-AC89-8B4850537F5B}
...
Source: {#BuildDir}\Landis.Extension.LinearWind-v2.dll; DestDir: {#ExtDir}; Flags: replacesameversion

; Requisite auxiliary libraries
; NB. These libraries are used by other extensions and thus are never uninstalled.
Source: {#BuildDir}\Landis.Library.Landis.Library.Metadata-v2.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
...
#define InfoTxt "Linear Wind 2.0.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Linear Wind"" "; WorkingDir: {#LandisPlugInDir}
